...
> **마지막 업데이트: 2026-04-07 (gateway-webserver 분석 drift 로그 점검 + optional provenance warning 제거 반영)**
...
- 최신 마감 세션 기록: `wiki/canon/handoff/s5/session-20.md` (architect 승인 + 문서 closeout)
- 최근 작업 세션 기록: `wiki/canon/handoff/s5/session-omx-1775463912798-zi6w92.md` (gateway-webserver drift 점검 + legacy provenance warning 원인 분석/수정)
...
| test_code_graph_service.py | 17 | CodeGraphService mock + origin + provenance seam + optional provenance warning 회귀 |
...
| 최신 마감 세션 | `wiki/canon/handoff/s5/session-20.md` |
| 최근 작업 세션 | `wiki/canon/handoff/s5/session-omx-1775463912798-zi6w92.md` |
