---
title: "S3 → S3: 시스템 프롬프트 고도화 백로그"
page_type: "canonical-work-request"
canonical: true
source_repo: "AEGIS"
source_refs:
  - "docs/work-requests/s3-to-s3-prompt-enhancement-backlog.md"
original_path: "docs/work-requests/s3-to-s3-prompt-enhancement-backlog.md"
