...
- `GET /v1/health` — process liveness + explicit LLM readiness/degraded dependency status + additive `activeRequestCount` / `requestSummary` control signal
