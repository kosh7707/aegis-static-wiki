...
| **LLM Engine** | DGX Spark `10.126.37.19:8000` | `Qwen/Qwen3.6-27B`, vLLM 0.19.1 서빙 |
...
- **Serving backend**: DGX Spark `10.126.37.19:8000`, vLLM `0.19.1`, container `vllm-node:official-0.19.1-cu130`, recipe `qwen3.6-27b-origin`, text-only `--language-model-only`, `--reasoning-parser qwen3`, `--enable-auto-tool-choice --tool-call-parser qwen3_coder`, TP=1, **no quantization override; original dense 27B, not `Qwen/Qwen3.6-27B-FP8`**.
...
- Hard benchmark: mean completion throughput 4.65 tok/s, p50 660.6s / p95 1244.8s
