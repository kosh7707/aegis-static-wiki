...
decision_tags: ["structured-output", "analysis-agent", "contract", "http-status", "state-machine", "agent-v1.1", "wp-0a", "schema-delegation", "claim-diagnostics"]
...
### 최근 검증 결과
- analysis-agent full suite: **493 passed in 5.51s**
- build-agent sibling suite for S3 boundary regression: **257 passed in 0.55s**
