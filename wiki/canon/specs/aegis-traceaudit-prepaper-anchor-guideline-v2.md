---
title: "AEGIS TraceAudit Pre-Paper Anchor Guideline v2"
...
decision_tags: ["prepaper-anchor", "traceaudit", "auditability", "sast-triage", "human-audit", "evidence-ledger", "freeze-before-results", "v2-review-incorporated", "critic-required"]
related_pages: ["wiki/canon/specs/aegis-traceaudit-prepaper-anchor-guideline-v1.md", "wiki/canon/specs/aegis-traceaudit-benchmark-master.md", "wiki/canon/specs/aegis-traceaudit-paper-dossier.md", "wiki/canon/specs/paper-analysis-pipeline-design.md", "wiki/canon/api/paper-analysis-api.md"]
---

# AEGIS TraceAudit Pre-Paper Anchor Guideline v2

> Status: v2 review-incorporated pre-paper anchor guideline; Critic re-review pending for v3.
> Version note: v2 incorporates the second 2026-05-18 external review; v1 is archived at `aegis-traceaudit-prepaper-anchor-guideline-v1.md`.
...
New v2 Critic re-review: pending. This section must be updated in v3.
...
## 31. Final v2 decision

This v2 guideline is the single pre-paper anchor candidate after applying the second external review. It is not final until Critic re-review is incorporated into v3 and the latest canonical alias is updated.
