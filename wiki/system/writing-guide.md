...
- `wiki/system/work-request-policy.md` — canonical WR semantics and MCP expectations
...
- Use `list_my_open_wrs`, `register_wr`, and `complete_wr` for canonical WR lifecycle operations
