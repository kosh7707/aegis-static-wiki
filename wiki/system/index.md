...
- [[wiki/canon/handoff/s7/architecture|S7 LLM Gateway — 아키텍처 상세]] — 이 문서는 Gateway 코드의 구조, 요청 처리 흐름, 환경변수, Observability를 상세히 기술한다. *(verified 2026-05-08; s7)*
...
- [[wiki/canon/handoff/s7/readme|S7. LLM Gateway + LLM Engine 인수인계서]] — 반드시 docs/AEGIS.md를 먼저 읽을 것. 프로젝트 공통 제약 사항, 역할 정의, 소유권이 그 문서에 있다. *(verified 2026-05-08; s7)*
...
- [[wiki/canon/work-requests/s7-to-s2-s7-reply-v1-tasks-remains-finite-taskresponse-compatibility-health-is-progress-o|S7 reply: /v1/tasks remains finite TaskResponse compatibility; health is progress-only]] — - Kind: reply *(verified 2026-05-08; s7)*
