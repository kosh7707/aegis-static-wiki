...
- [[wiki/canon/specs/analysis-agent|S3. Analysis Agent 기능 명세]] — 소유자: S3 *(verified 2026-04-27; s3)*
- [[wiki/canon/specs/backend|S2. Core Service 기능 명세]] — Express.js + TypeScript 기반 백엔드 서비스 *(verified 2026-04-25; s2)*
...
- [[wiki/canon/specs/llm-engine|S7. LLM Engine 기능 명세]] — Current serving default (verified 2026-04-25): Qwen/Qwen3.6-27B. *(verified 2026-04-25; s7)*
- [[wiki/canon/specs/llm-gateway|S7. LLM Gateway 기능 명세 (AEGIS)]] — S7은 AEGIS 플랫폼의 LLM 단일 관문(Gateway) 이자 LLM Engine 운영자이다. *(verified 2026-04-25; s7)*
...
- [[wiki/canon/specs/s3-claim-evidence-state-machine/claim-lifecycle|S3 Claim Lifecycle Statechart]] — Status: draft *(verified 2026-04-23; s3/analysis-agent)*
- [[wiki/canon/specs/s3-claim-evidence-state-machine/evidence-ref-and-slots|S3 EvidenceRef and EvidenceSlot Contract]] — Status: draft *(verified 2026-04-23; s3/analysis-agent/s4/s5)*
...
- [[wiki/canon/api/analysis-agent-api|Analysis Agent API 명세]] — 소유자: S3 *(verified 2026-04-25; s3/analysis-agent/api-contract)*
- [[wiki/canon/api/build-agent-api|Build Agent API 명세 (v1.0.0)]] — 소유자: S3 *(verified 2026-04-25; s3)*
...
- [[wiki/canon/api/shared-models|Shared (S1-S2) API / Model Contract]] — Canonical contract for the current S1 (frontend) ↔ S2 (backend) integration. *(verified 2026-04-25; platform)*
...
- [[wiki/canon/handoff/s2/api-endpoints|S2 API 엔드포인트 전체 목록]] — S2(AEGIS Core)가 S1에 제공하는 모든 REST API + WebSocket 엔드포인트 *(verified 2026-04-25; s2)*
...
- [[wiki/canon/handoff/s3/readme|S3. Analysis Agent 인수인계서]] — 반드시 docs/AEGIS.md를 먼저 읽을 것. *(verified 2026-04-27; s3)*
...
- [[wiki/canon/handoff/s3/session-omx-1777019958462-zau7uq|Session history — s3 / omx-1777019958462-zau7uq]] — - Lane: s3 *(verified 2026-04-24; s3)*
...
- [[wiki/canon/handoff/s7/architecture|S7 LLM Gateway — 아키텍처 상세]] — 이 문서는 Gateway 코드의 구조, 요청 처리 흐름, 환경변수, Observability를 상세히 기술한다. *(verified 2026-04-23; s7)*
- [[wiki/canon/handoff/s7/llm-engine-ops|S7 LLM Engine — 운영 정보]] — DGX Spark에서 구동되는 S7 LLM Engine(vLLM)의 접속, 기동, 성능, 트러블슈팅 정보. *(verified 2026-04-25; s7)*
- [[wiki/canon/handoff/s7/readme|S7. LLM Gateway + LLM Engine 인수인계서]] — 반드시 docs/AEGIS.md를 먼저 읽을 것. 프로젝트 공통 제약 사항, 역할 정의, 소유권이 그 문서에 있다. *(verified 2026-04-25; s7)*
...
- [[wiki/canon/work-requests/s1-to-designer-canonical-handoff-components-nav.css-.nav-icon-.badge---severity-critical-doctri|canonical handoff/components/nav.css — `.nav-icon .badge` 가 `--severity-critical` 직접 사용 (doctrine §3.4 violation)]] — - Kind: request *(verified 2026-04-25; s1/design-system/navbar)*
- [[wiki/canon/work-requests/s1-to-designer-canonical-tokens.css-paperlogy-unified-mono-drift-design.md-1-4-vs-geist-mono|canonical tokens.css — Paperlogy-unified mono drift 공식화 결정 요청 (DESIGN.md §1·§4 갱신 vs Geist Mono 패키지 동반 도입)]] — - Kind: request *(verified 2026-04-27; s1/design-system/typography)*
- [[wiki/canon/work-requests/s1-to-designer-design-system-readme.md-7-handoff-s1-bootstrap.md|design-system/readme.md §7 라우팅에 handoff/s1/bootstrap.md 진입 링크 추가 요청]] — - Kind: request *(verified 2026-04-25; s1/s1-qa/design-system)*
- [[wiki/canon/work-requests/s1-to-designer-dynamicanalysispage-terminal-aesthetic---console-fg--bg--bg-hi--green--amber--re|DynamicAnalysisPage 콘솔 terminal aesthetic 토큰 (--console-fg/-bg/-bg-hi/-green/-amber/-red/-red-soft) canonical 흡수 또는 page-scoped 정식화 결정 요청]] — - Kind: request *(verified 2026-04-27; s1/design-system/dynamic-analysis)*
...
- [[wiki/canon/work-requests/s4-to-s3-reply-s4-confirms-sast-build-health-and-failure-boundary-rules-for-s3-stability-|Reply: S4 confirms SAST/build health and failure-boundary rules for S3 stability preflight]] — - Kind: reply *(verified 2026-04-25; s4/s3/sast-runner/analysis-agent/system-stability/health)*
...
- [[wiki/canon/work-requests/s4-to-s3-reply-s4-notice-specific-acknowledgement-for-s3-system-stability-contract|Reply: S4 notice-specific acknowledgement for S3 system-stability contract]] — - Kind: reply *(verified 2026-04-25; s4/s3/sast-runner/analysis-agent/system-stability)*
...
- [[wiki/canon/work-requests/s5-to-s3-reply-s5-kb-graphrag-readiness-and-evidence-role-semantics-for-s3-system-stabili|Reply: S5 KB/GraphRAG readiness and evidence-role semantics for S3 system stability]] — - Kind: reply *(verified 2026-04-25; s5/s3/knowledge-base/analysis-agent/graphrag/system-stability)*
...
- [[wiki/canon/work-requests/s7-to-s3-s7-reply-system-stability-async-timeout-strict-json-failure-boundary-contract-co|S7 reply — system-stability async/timeout/strict-JSON failure-boundary contract confirmed]] — - Kind: reply *(verified 2026-04-25; s7/llm-gateway/llm-engine/strict-json/async-ownership)*
...
- [[wiki/system/index|AEGIS static wiki index]] — Content-oriented catalog of the wiki. Agents should read this first to locate relevant pages before drilling into individual documents. *(verified 2026-04-27; platform)*
