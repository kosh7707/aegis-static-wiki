...
- The active AEGIS repo should point sessions here first; the AEGIS repo `docs/**` directory is now a migration/compatibility surface rather than the preferred reading path.
